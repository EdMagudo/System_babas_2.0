...
const Overview = ({ clientProfile, idUser }) => {
  ...
  useEffect(() => {
    const fetchUserProfile = async () => {
      ...
      try {
        const response = await axios.get(`https://145.223.103.28:3005/api/client/${idUser}`);
    ...
    const fetchCompletedJobs = async () => {
      ...
      try {
        const response = await axios.get(
          `https://145.223.103.28:3005/api/reservations/countReservationsC/${idUser}`
        );
  ...
  const handleSavePhone = async () => {
    ...
    try {
      const response = await axios.put(
        `https://145.223.103.28:3005/api/user/save/Phone/${idUser}`,
        { phone }
      );
  ...
  const handlePasswordChange = async (e) => {
    ...
    try {
      const response = await axios.put("https://145.223.103.28:3005/api/user/upd/Pas", {
        email,
        currentPassword,
        newPassword,
      });
