                  ...
                  {reservation.status === "confirmed" && (
                    <div className="flex gap-4">
                      ...
                      >
                        ...
                        <button
                          type="submit"
                          className="px-6 py-3 text-lg font-medium text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-md transition-colors duration-200"
                        >
                          Pay with PayPal
                        </button>
                      </form>
                      ...
                      >
                        ...
                        <button
                          type="submit"
                          className="px-6 py-3 text-lg font-medium text-green-600 hover:text-green-700 hover:bg-green-50 rounded-md transition-colors duration-200"
                        >
                          Pay with M-Pesa
                        </button>
                      </form>
