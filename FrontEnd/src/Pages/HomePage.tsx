      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto leading-relaxed">
            Welcome to Express Nannies, your trusted platform for finding
            reliable temporary nannies in Mozambique. Whether you're a tourist
            enjoying a night out, an expat in need of temporary support, or a
            parent whose nanny is unavailable, we're here to provide peace of
            mind with vetted, experienced caregivers.
          </p>
        </div>
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mb-8">
            Discover our diverse community of experienced nannies ready to
            provide exceptional care for your children
          </p>
        </div>
      </div>
    </div>
